...
export const publishPhoto = createAsyncThunk(
    ...
    export const getPhotos = createAsyncThunk("photo/getall", async(_, thunkAPI) => { //o _ é para ignorar o parametro
