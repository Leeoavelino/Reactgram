...
//redux
import { getUserDetails } from "../../slices/useSlice"
...
const Profile = () => {
    ...
    //funçoes de foto (para adicionar as imagens no sistema)
    const newPhotoForm = useRef()
    const editPhotoForm = useRef()

    //carregar o usuario
    useEffect(() => {
        dispatch(getUserDetails(id)) //funçao de redux que foi importada de outro arquivo
    ...
    //funçao para exibir o formulario
    ...
    //abrir a parte da ediçao de fotos
    ...
    return(
        <div id="profile">
            ...
            {/* checar se o usuario que esta acessando o perfil é o dono do perfil */}
            {id === userAuth._id && (
                <>
                    ...
                    <div className="edit-photo hide" ref={editPhotoForm}>
                        ...
                        <form onSubmit={handleUpdate}>
                            ...
                            <input type="text" placeholder="Insira o novo titulo" onChange={(e) => setEditTitle(e.target.value)} value={editTitle || ""} />
